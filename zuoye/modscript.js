...
//           slotContent = data
//             .match(slotReg)[1]
//             .replace(pathReg, "/" + option.remotePath + "/attachement");
//           if (env != "local") {
//             slotContent = data
//               .match(slotReg)[1]
//               .replace(/\.\.\//g, "http://www.mod.gov.cn/");
//           }
...
//     var big5Path = window.location.href.indexOf("/big5/") > 0 ? "big5/" : "";
//     sourceUrl = {
//       url: {
//         web: "http://" + hostName + "/" + big5Path + "qj/node_49022.htm",
//         local:
//           "http://10.8.60.200:7001/servlet/PagePreviewServlet?siteid=21&nodeid=49022&type=0",
//       },
//       preScriptSrc:
//         "http://10.8.60.200:7001/data/enp/site21/15741.files/data-slot-proxy.js",
//       webScriptSrc: "http://" + hostName + "/15741.files/modscript.js",
//     };
//   })();
// var slot = new DataSlot(
//   { url: sourceUrl.url, remotePath: "datasource" },
//   addEventOnMenu
// );
